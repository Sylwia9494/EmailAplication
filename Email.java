...
public class Email {
    ...
    // Costructor to receive first name, last name
    ...
    private String generate_email() {
        return this.firstname.toLowerCase() + this.lastname.toLowerCase() + "@" + this.dept.toLowerCase()+ ".company";
    }
    // Asking for dept
    ...
    private String generate_password(int length) {
        Random r = new Random();
        String Capital_chars = "ABCDEFGHIJKLMNOPQRSTUWVXYZ";
        String Small_chars = "abcdefghijklmnopqrstuwvxyz";
    ...
    public void storeFile() {
        try {
            FileWriter in = new FileWriter("C:\\Users\\Del\\Desktop\\info.txt");
        ...
        try{
            FileReader f1 = new FileReader("C:\\Users\\Del\\Desktop\\info.txt");
            int i;
            while ((i = f1.read())!=-1){
